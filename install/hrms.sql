...
CREATE TABLE `main_pa_employee_ratings` (
  ...
  `appraisal_status` enum('Pending employee ratings','Pending L1 ratings','Pending L2 ratings','Pending L3 ratings','Pending L4 ratings','Pending L5 ratings', 'Pending employee finalization', 'Completed') DEFAULT 'Pending employee ratings' COMMENT '1=Pending employee ratings,2=Pending L1 ratings,3=Pending L2 ratings,4=Pending L3 ratings,5=Pending L4 ratings,6=Pending L5 ratings,7=Pending employee finalization, 8=Completed,',
  `createdby` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `main_pa_questions` (
  ...
  `pa_type_id` bigint(20) unsigned DEFAULT NULL,
